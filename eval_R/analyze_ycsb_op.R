...
toplevel_path <- "~/git/data_eval/50reads-50updates/";
...
d <- subset(d,d$timestamp - start_time < duration_run)
...
#Throughput plot
throughput.plot <- ggplot(d, aes(timestamp,..density..)) + geom_freqpoly(binwidth=1000) 
throughput.plot
