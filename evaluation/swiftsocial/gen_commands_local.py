...
#       + OUR MODIFICATIONS TO PRODUCE MORE FRIENDS-BIASED WORKLOAD
import sys, os, base64, random, time

activities = ["Running Experiments","Drinking Coffee","Sleeping","Writing papers"]
allUsers = []
...
def main():
  numUsers=0
  if (len(sys.argv) != 9):
    print "Usage ", sys.argv[0],"<users_file> <number_of_friends> <ops_per_session_biased> <ops_per_session_random> <total_ops> <num_sites> <active_users> <out_file>"
    sys.exit()
