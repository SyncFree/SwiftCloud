...
public class GetSharedLockUpdate implements CRDTUpdate<SharedLockCRDT> {
    ...
    // required for kryo
    public GetSharedLockUpdate() {
    }

    public GetSharedLockUpdate(String requesterId, String parentId, LockType type, TripleTimestamp timestamp) {
