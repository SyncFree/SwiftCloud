 ...
 * @author mzawirsk
 */
public class PutOnlyLWWMapCRDT<K, V> extends BaseCRDT<PutOnlyLWWMapCRDT<K, V>> {
    protected static class LWWEntry<V> {
        protected V val;
    ...
    public void put(K key, V value) {
        ...
        entry.val = value;
        registerLocalOperation(new PutOnlyLWWMapUpdate<K, V>(key, entry.timestamp, entry.timestampTiebreaker, entry.val));
    }
