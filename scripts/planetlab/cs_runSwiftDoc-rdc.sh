...
#ec2-46-137-67-215.eu-west-1.compute.amazonaws.com
...
ec2-46-51-129-106.eu-west-1.compute.amazonaws.com
ec2-46-137-67-215.eu-west-1.compute.amazonaws.com
)
...
output_prefix=results/swiftdoc/1pc-rdc-result-cdn-swiftdoc-$ISOLATION-$CACHING-$NOTIFICATIONS.log
for client in ${ENDCLIENTS[*]}; do
