...
DC2=$EC2_US_OREGON
DCS="$DC1 $DC2"
DC1_CLIENTS="$EC2_ASIA_SINGAPORE1 $EC2_ASIA_SINGAPORE2 $EC2_ASIA_SINGAPORE3 $EC2_EU1 $EC_EU2"
DC2_CLIENTS="$EC2_US_NORTHCALIFORNIA1 $EC2_US_NORTHCALIFORNIA2 $EC2_US_NORTHCALIFORNIA3 $EC2_EU3 $EC2_EU4"
