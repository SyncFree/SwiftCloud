...
int l = 500, h = 120;
processRootDir.call( l, h, DIR +"Mar14-1363299160038", "3 DC");
processRootDir.call( l, h, DIR +"Mar14-1363298777609", "3 DC");
processRootDir.call( l, h, DIR +"Mar14-1363298370556", "3 DC");
processRootDir.call( l, h, DIR +"Mar14-1363297939202", "3 DC");

processRootDir.call( l, h, DIR +"Mar15-1363382925534", "3 DC");
processRootDir.call( l, h, DIR +"Mar15-1363381854426", "3 DC");
processRootDir.call( l, h, DIR +"Mar15-1363382386484", "3 DC");

processRootDir.call( l, h, DIR +"Mar15-1363384331754", "2 DC");
processRootDir.call( l, h, DIR +"Mar15-1363384713504", "2 DC");
processRootDir.call( l, h, DIR +"Mar15-1363385649786", "2 DC");
processRootDir.call( l, h, DIR +"Mar15-1363385097700", "2 DC");
processRootDir.call( l, h, DIR +"Mar15-1363389850554", "2 DC");
processRootDir.call( l, h, DIR +"Mar15-1363387766424", "2 DC");
processRootDir.call( l, h, DIR +"Mar15-1363386934296", "2 DC");

processRootDir.call( l, h, DIR +"Mar16-1363392148881", "1 DC");
processRootDir.call( l, h, DIR +"Mar16-1363395534834", "1 DC");
processRootDir.call( l, h, DIR +"Mar16-1363395104669", "1 DC");
processRootDir.call( l, h, DIR +"Mar16-1363396220965", "1 DC");
processRootDir.call( l, h, DIR +"Mar15-1363391062998", "1 DC");
processRootDir.call( l, h, DIR +"Mar15-1363390595587", "1 DC");
...
String outputFile = "/tmp/sosp/swiftsocial-scout-at-client-w91-lat-vs-perf"
