...
[
    ...
    [
        ...
        [
            ...
            def dstDir="results/ycsb/multi-DC/" + "scalabilityclients/" + new Date().format('MMMdd-') + System.currentTimeMillis() + "-" + Version + "-" +
                    String.format("%s-mode-%s-clients-%d", WorkloadName, ModeName, Threads * Scouts.size())
