...
class PlanetLab_3X {
    ...
    static def PlanetLab_EU = PlanetLab_EU_ALL.subList(EU, min(EU + maxPerRegion, PlanetLab_EU_ALL.size()) )

    static private def int NC = 6
    static def PlanetLab_NC = PlanetLab_NC_ALL.subList(NC, min(NC + maxPerRegion, PlanetLab_NC_ALL.size()) )

    static def PlanetLab_NV_ALL2 = PlanetLab_NV_ALL - PlanetLab_NC

    static private def int NV = 10
    static def PlanetLab_NV = PlanetLab_NV_ALL2.subList(NV, min(NV + maxPerRegion, PlanetLab_NV_ALL2.size()) )

    static private def int JP = 0
    static def PlanetLab_JP = PlanetLab_JP_ALL.subList(JP, min(JP + maxPerRegion, PlanetLab_JP_ALL.size()) )
