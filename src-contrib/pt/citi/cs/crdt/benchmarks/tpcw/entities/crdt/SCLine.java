...
public class SCLine implements Copyable {
    ...
    public int getSCL_QTY(TxnHandle txh) throws WrongTypeException, NoSuchObjectException, VersionNotFoundException,
            NetworkException {
        IntegerCRDT quantity = txh.get(SCL_QTY, true, IntegerCRDT.class);
        return quantity.getValue();
    }

    public void addSCL_QTY(int qTY, TxnHandle txh) throws WrongTypeException, NoSuchObjectException,
