 ...
 *
 */
public class CCIncrementalTimestampGenerator 
    implements TimestampSource<Timestamp> {
    ...
    @Override
    public <V extends CausalityClock<V>> Timestamp generateNew(CausalityClock<V> c) throws InvalidParameterException {
