...
public class AmazonMachine {
    ...
    public class Requests {
        ...
        /**
         * The only information needed to create a client are security
         * credentials consisting of the AWS Access Key ID and Secret Access
         * Key. All other configuration, such as the service endpoints, are
         * performed automatically. Client parameters, such as proxies, can be
         * specified in an optional ClientConfiguration object when constructing
         * a client.
         *
         ...
         *
         * Note the AMI id may change after the release of this code sample, and
         * it is important to use the latest. You can find the latest version by
         ...
         * started are still in the open state. If all of them have transitioned
         * to either active, cancelled, or closed, then this will return false.
         *
         * @return
         */
