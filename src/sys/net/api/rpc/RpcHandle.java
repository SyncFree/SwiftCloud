...
public interface RpcHandle {
	...
	/**
	 * Telss if this handle was generated by a send operation that supplied a reply handler
	 * @return true/false if the message associated with this handle expects a reply.
	 */
	...
	/**
	 * By default streaming replies for a given send operation are disabled, only the first reply will be accepted.
	 * @param flag - flag to control if accepting multiple replies for a send is enabled or disabled.
	 */
	void enableStreamingReplies( boolean flag ) ;
	
	/**
	 * In blocking mode, this method return the handle to the reply message.
	 * 
	 * @return The handle associated with the reply to the message sent that returned this handle
	 */
	RpcHandle getReply();
}
