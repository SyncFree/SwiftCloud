...
import sys.net.impl.rpc.RpcEndpointImpl;
...
public class NetworkingImpl extends Networking {
    ...
    @Override
    public Endpoint bind(final int tcpPort) {
    ...
    @Override
    public RpcEndpoint rpcBind(final int tcpPort, final RpcHandler handler) {
        Endpoint e = bind(tcpPort);
        return new RpcEndpointImpl(e, handler);
    }
