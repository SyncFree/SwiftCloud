...
/**
 * Used to instruct the Kryo serializer about the classes used in the Catadupa 1-hop DHT.
 * 
 * Manually registering classes will reduze the size of serialization and speed things up (apparently...).
 * @author smd
 *
 */
